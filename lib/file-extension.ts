...
} as const satisfies Record<string, MimeString>;

type KnownFileExtension = keyof typeof FileExtensionMap;

export type FileExtension = KnownFileExtension | (string & {});
export type FileExtensionWithDot = `.${KnownFileExtension}` | (string & {});
...
export function inferMimeFromExtension(extension: FileExtension): MimeString | undefined {
    return (FileExtensionMap as Record<string, MimeString>)[extension];
}
